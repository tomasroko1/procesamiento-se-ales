...
def main():
    parser = argparse.ArgumentParser(description="Replicate Mizuseki 2009 (Theta Phase).")
    ...
    lfp = load_lfp(session, channel_id=0) # Load all for duration? Default 100s for speed in demo
